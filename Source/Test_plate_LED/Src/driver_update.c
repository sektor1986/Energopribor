...
uint8_t data1_spi[4] = {0xFF, 0xFF, 0xFF, 0xFF};
uint8_t data2_spi[4] = {0xFF, 0xFF, 0xFF, 0xFF};
uint8_t data3_spi[4] = {0xFF, 0xFF, 0xFF, 0xFF};
uint8_t data4_spi[4] = {0xFF, 0xFF, 0xFF, 0xFF};
...
//	Timer_Start(TIMER_ID_4IMP, 2, TRUE, LED_update_task);	
}
...
void button_callback(uint16_t u16ButtonId, en_button_state_t enState)
{
	...
	switch (enState)
	{
		...
		case StateLow:
			...
			sConfigOC.Pulse = 100 * brightness_value;
